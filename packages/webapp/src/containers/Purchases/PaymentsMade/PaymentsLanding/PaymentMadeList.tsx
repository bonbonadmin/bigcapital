...
import { useExpensePayments, useRefreshExpensePayments } from '@/hooks/query/expensePayments';
import { usePaymentMades, useRefreshPaymentMades } from '@/hooks/query/paymentMades';
...
function PaymentMadeList({ openDrawer }) {
...
export default compose(withDrawerActions)(PaymentMadeList);
