...
const Schema = Yup.object().shape({
  ...
  statement: Yup.string().max(DATATYPES_LENGTH.TEXT).nullable(),
...
export const CreateExpensePaymentFormSchema = Schema;
export const EditExpensePaymentFormSchema = Schema;
